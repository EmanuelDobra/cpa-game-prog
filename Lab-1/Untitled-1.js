...
lib.ssMetadata = [
		{name:"Untitled_1_atlas_", frames: [[0,0,1040,499],[0,501,1040,499],[0,1002,1040,499],[0,1503,1040,493]]},
		{name:"Untitled_1_atlas_2", frames: [[0,982,1248,329],[1356,0,193,59],[1042,0,312,162],[1042,277,104,294],[1042,164,367,111],[0,0,1040,490],[0,492,1040,488]]}
];
...
(lib.Untitled1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7},{t:this.instance_6,p:{rotation:0,x:432.2,y:254.3,regX:91.8,regY:27.8,scaleX:1,scaleY:1}},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3,p:{x:101,y:322.5}},{t:this.instance_2,p:{rotation:0,x:411.3,y:215.35,regX:24.2,regY:6.9,scaleX:1,scaleY:1}}]}).to({state:[{t:this.instance_8},{t:this.instance_6,p:{rotation:8.4648,x:409.2,y:254.55,regX:91.8,regY:27.8,scaleX:1,scaleY:1}},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3,p:{x:124.2,y:336}},{t:this.instance_2,p:{rotation:8.4648,x:394.25,y:212.95,regX:24.2,regY:6.9,scaleX:1,scaleY:1}}]},9).to({state:[{t:this.instance_9},{t:this.instance_6,p:{rotation:-0.2125,x:406.15,y:255.7,regX:91.9,regY:27.9,scaleX:1,scaleY:1}},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3,p:{x:159,y:322.5}},{t:this.instance_2,p:{rotation:-0.2125,x:385.15,y:216.8,regX:24.4,regY:7,scaleX:1,scaleY:1}}]},10).to({state:[{t:this.instance_10},{t:this.instance_6,p:{rotation:11.0409,x:395.75,y:256.6,regX:92,regY:27.9,scaleX:1,scaleY:1}},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3,p:{x:183.75,y:351.85}},{t:this.instance_2,p:{rotation:11.0409,x:382.65,y:214.35,regX:24.4,regY:7.1,scaleX:1,scaleY:1}}]},10).to({state:[{t:this.instance_11},{t:this.instance_6,p:{rotation:0.8097,x:378.4,y:256.9,regX:92,regY:27.9,scaleX:0.9999,scaleY:0.9999}},{t:this.instance_5},{t:this.instance_4}]},10).to({state:[{t:this.instance_12},{t:this.instance_6,p:{rotation:0.8097,x:378.4,y:256.9,regX:92,regY:27.9,scaleX:0.9999,scaleY:0.9999}},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3,p:{x:245.5,y:348.9}},{t:this.instance_2,p:{rotation:0.8097,x:358,y:217.8,regX:24.4,regY:7.2,scaleX:0.9999,scaleY:0.9999}}]},10).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(245.2,206.8,349.00000000000006,214.09999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Untitled_1_atlas_.png?1642605333571", id:"Untitled_1_atlas_"},
		{src:"images/Untitled_1_atlas_2.png?1642605333571", id:"Untitled_1_atlas_2"}
	],
	preloads: []
};
